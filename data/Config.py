...
class Configurable(object):
    ...
    @property
    def conjunction_file(self):
        return self._config.get('Data','conjunction_file')
    @property
    ...
    @property
    def min_masked_occur_count(self):
        return self._config.getint('Data','min_masked_occur_count')
    @property
    def max_edu_len(self):
        return self._config.getint('Data','max_edu_len')
    @property
    def max_edu_num(self):
        return self._config.getint('Data','max_edu_num')
    @property
    def min_edu_num(self):
        return self._config.getint('Data','min_edu_num')
    @property
    def geo_clip(self):
        return self._config.getint('Data','geo_clip')
    @property
    def geo_p(self):
        return self._config.getfloat('Data','geo_p')
